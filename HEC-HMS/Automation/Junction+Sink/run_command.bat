...
set PROJ_LIB=C:\Users\Leela\AppData\Local\Programs\Python\Python312\Lib\site-packages\pyproj\proj_dir\share\proj
...
"C:\Program Files\HEC\HEC-HMS\4.13\jre\bin\java.exe" ^
    ...
    hms.Hms -script "C:\Users\Leela\Desktop\HEC-HMS_Automation\global_summary.py"
