...
def seventy_five_dependiblity(global_summary_excel):
    ...
    for sheet_name in junction_frames.keys():
        ...
        summary_data.append((sheet_name, year_val, round(best_val, 4)))
    ...
    if summary_data:
        ...
        headers = ["Junctions", "Year", "Dependability (%)"]
        ...
        # Write rows (only three columns)
        for row_idx, (junction, year_val, dep_val) in enumerate(summary_data, start=2):
...
# === Example usage ===
INPUT_PATH = r"C:\Users\Swapnali\Desktop\Stages (HEC-HMS)\Seventy Five Percent Dependibilty\global_summary.xlsx"
# "C:\Users\USER\Desktop\sakina_script\75 percent dependibilty\global_summary_vaitarna.xlsx"
